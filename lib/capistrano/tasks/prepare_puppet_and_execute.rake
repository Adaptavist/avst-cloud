...
task :prepare_puppet_and_execute do
    on roles(:app) do |host|
        if ENV["puppet_runner"]
            ...
            SSHKit.config.command_map[:install_r10k] = "sudo su -c 'source /usr/local/rvm/scripts/rvm; gem install cri -v 2.12.0; gem install r10k -v 3.0.0'"
